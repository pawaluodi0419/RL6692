...
u8 _by_Pattern8_dut1()
{
	...
	case 0x0000:
	{
		...
		{
			Buff_dut1_XGPIO_0[0] = 0x35;                            //REG0005 ouput value[7:0]
	...
	case 0x0003:
	{
		...
		{
			xil_printf("dut1 REG_PWR =%x\r\n", (dut1.g_pattern_smbus_control_buf[10] >> 5) & 0x07);
			xil_printf("dut1 REG_TRIM_CC_OVP =%x\r\n", (dut1.g_pattern_smbus_control_buf[11]) & 0x0f);
