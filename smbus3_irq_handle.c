...
//				}
				...
				case 0x01:
				{
					...
					else
					{
						...
						dut3.g_smbus_retry_timer = 0x7d0;
						dut3.g_pattern_smbus_control_buf[0] = smbus_road_doing;
						smbus3_process_state = smbus_road_doing;
...
//			}
	...
	//smbus_read//
	if(((smbus3_cmd_code & 0x30) == 0x30) | (smbus3_cmd_code == 0x24) | ((smbus3_cmd_code == 0x01) && (smbus3_cmd_code_add == 0x04)))
	{
		switch(smbus3_process_state)
		{
		case smbus_road_waiting:
	...
	if(((smbus3_cmd_code == 0x01) && (smbus3_cmd_code_add == 0xda)) | (smbus3_cmd_code == 0x02) | (smbus3_cmd_code == 0x03) | (smbus3_cmd_code == 0x05))
	{
		switch(smbus3_process_state)
		{
		case smbus_road_waiting:
