...
u8 _by_PatternF_efuse_dut3()
{
	...
	case 0x0000:
	{
		if(dut3.g_dut_pattern_status_buf[7] == 0x00)
		{
			...
			xil_printf("dut3.patternF_gpio_control_completed!\r\n");
			msdelay(10);
		}
...
//			for(i=0;i<60;i++)
//			{
//				dut3.g_read_ft2_data[i] = 0;
//			}
//
//			for(i=0;i<22;i++)
//			{
//				dut3.g_read_ft2_data[i] = dut3.g_pattern_smbus_control_buf[i+10];
//			}
//
//			for(i=0;i<22;i++)
//			{
//				xil_printf("dut3.ft2_data[%02d]= %02x\r\n", i, dut3.g_read_ft2_data[i]);
//			}
//
//			xil_printf("\r\n");
//
...
//			for(i=0;i<60;i++)
//			{
//				dut3.g_read_flash_data[i] = 0;
//			}
//
//			for(i=0;i<22;i++)
//			{
//				dut3.g_read_flash_data[i] = dut3.g_pattern_smbus_control_buf[i+10];
//			}
//
//			for(i=0;i<22;i++)
//			{
//				xil_printf("dut3.flash_data[%02d]= %02x\r\n", i, dut3.g_read_flash_data[i]);
//			}
//
//			xil_printf("\r\n");
//
...
//	{
//		dut3.g_pattern_smbus_control_buf[1] = smbus_cmd_type_geticstatus;
//		dut3.g_pattern_smbus_control_buf[2] = 0x23;
//		dut3.g_pattern_smbus_control_buf[3] = 0x00;
...
//			for(i=0;i<60;i++)
//			{
//				dut3.g_read_efuse_data[i] = 0;
//			}
//
//			for(i=0;i<20;i++)
//			{
//				dut3.g_read_efuse_data[i] = dut3.g_pattern_smbus_control_buf[i+10];
//			}
//
//			for(i=0;i<20;i++)
//			{
//				xil_printf("dut3.efuse_data[%02d]= %02x\r\n", i, dut3.g_read_efuse_data[i]);
//			}
//
//			for(i=1; i<60; i++)
//			{
...
//	{
//		dut3.g_pattern_smbus_control_buf[1] = smbus_cmd_type_geticstatus;
//		dut3.g_pattern_smbus_control_buf[2] = 0x24;
//		dut3.g_pattern_smbus_control_buf[3] = 0x00;
//		dut3.g_pattern_smbus_control_buf[4] = 0x14;
//
//		smbus3_irq_handle(dut3.g_pattern_smbus_control_buf);
...
//			for(i=0;i<20;i++)
//			{
//				dut3.g_read_efuse_data[i+20] = dut3.g_pattern_smbus_control_buf[i+10];
//			}
//
//			for(i=0;i<20;i++)
//			{
//				xil_printf("dut3.efuse_data[%02d]= %02x\r\n", i+20, dut3.g_read_efuse_data[i+20]);
//			}
//
//			for(i=1; i<60; i++)
//			{
...
//			for(i=0;i<22;i++)
//			{
//				if(dut3.g_read_ft2_data[i] == dut3.g_read_flash_data[i])
//				{
//					if(i == 21)
//					{
//						dut3.g_pattern_step++;
...
//					dut3.g_result_fail = 0x01;
//					dut3.g_result_fail_tmrcount = 0xffff;
//					xil_printf("dut3 compare ft2 data and flash data fail!\r\n\r\n");
//				}
//			}
//		}
//
...
//		for(i=0;i<40;i++)
//		{
//			dut3.g_pattern_smbus_control_buf[i+5] = dut3.g_read_efuse_data[i];
//		}
//
//		smbus3_irq_handle(dut3.g_pattern_smbus_control_buf);
//		if(dut3.g_pattern_smbus_control_buf[0] != smbus_road_done_pass)
...
//			for(i=0;i<40;i++)
//			{
//				if(dut3.g_read_efuse_data[i] != dut3.g_pattern_smbus_control_buf[i+10])
//				{
//					dut3.g_result_fail = 0x01;
//					dut3.g_result_fail_tmrcount = 0xffff;
//					xil_printf("dut3 compare efuse data fail!\r\n\r\n");
//				}
//				else
//				{
//					for(i=1; i<60; i++)
...
//					dut3.g_uartPatternNum = 0x10;
//					result_output_for_v50(XPAR_AXI_GPIO_dut3_1_BASEADDR,dut3.g_uartPatternNum);
//					xil_printf("dut3 compare efuse data pass!\r\n\r\n");
//					xil_printf("dut3.patternF_pass!\r\n\r\n");
//				}
//
//			}
